...
Automated daily pipeline that scrapes commodity prices from [SunSirs](https://sunsirs.com/uk/) and delivers a dashboard everyday (Vietnam time, UTC+7). Try the dashboard [here](https://ftu-kudo.github.io/Commodity_dashboard/).
